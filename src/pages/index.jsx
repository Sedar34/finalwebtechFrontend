        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-4">
              <li><a className="hover:underline" href="#"><FontAwesomeIcon icon={faHome} /> Home</a></li>
              <li><a className="hover:underline" href="#"><FontAwesomeIcon icon={faInfoCircle} /> About Us</a></li>
              <li><a className="hover:underline" href="#"><FontAwesomeIcon icon={faEnvelope} /> Contact Us</a></li>
              <li><a className="hover:underline" href="#"> Services</a></li>
              <li><a className="hover:underline" href="/login"><FontAwesomeIcon icon={faSignInAlt} /> Login</a></li>
              <li><a className="hover:underline" href="/register"><FontAwesomeIcon icon={faUserPlus} /> Register</a></li>
            </ul>
          </nav>
        </div>
      </header>
